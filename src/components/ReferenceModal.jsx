...
const ReferenceModal = ({}) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col text-center md:text-left md:items-start gap-2 bg-white rounded-lg w-[98vw] md:w-[75vw] mx-auto p-12 y-12 mt-6 md:mt-12 mb-20 max-w-[1200px]">
          <div className="relative w-full flex justify-end text-2xl">
            <button
